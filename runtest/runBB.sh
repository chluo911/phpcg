rm -rf ../../phpBB-3.2.3
cp -r ../../goal/phpBB-3.2.3 ../../phpBB-3.2.3
../../php-cs-fixer fix --rules=@PSR2 ../../phpBB-3.2.3
../../php-cs-fixer fix --rules=@PSR2 ../../phpBB-3.2.3/vendor/
../../phpjoern/php2ast /home/users/chluo/phpBB-3.2.3
